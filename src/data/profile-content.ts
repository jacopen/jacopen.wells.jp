import {
  blogPosts,
  presentations as latestPresentations,
  books,
  contributions,
} from "./blog-entries";
...
export const communities = [
  {
    name: "Platform Engineering Kaigi",
    url: "https://www.cnia.io/pek2024/",
    activity:
      "2024年に始まったPlatform Engineeringのカンファレンス。Chairを務める",
  },
  {
    name: "Platform Engineering Meetup",
    url: "https://platformengineering.connpass.com/",
    activity:
  ...
  },
  {
    ...
    activity:
      "日本最大のクラウドネイティブ技術の祭典。2019年から2023年までCo-Chairを務めた",
  },
  {
    name: "EMTEC",
    url: "https://emtec.tv/",
    activity:
      "最強のライブ配信チーム。IT系カンファレンスやミートアップのライブ配信に特化しており、Directorを担当している",
  },
  {
    name: "PagerDuty Community",
    url: "https://pagerduty.connpass.com/event/318379/",
    activity: "PagerDutyのコミュニティ。ミートアップの開催を主導",
  },
];
...
export const certifications = [
  {
    name: "DASA Accredited Trainer Badge - DASA Platform Engineering 2026",
    issuer: "DASA",
    date: "2025/12",
    credentialId: "",
    url: "https://www.credential.net/709fbfd1-2aba-428c-b41c-2ae5c603f49a#acc.vMjDq6No",
